...
export const SearchBar = ({ searchTerm, locationFilter, onSearchChange, onLocationChange }: SearchBarProps) => {
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault();
    // A busca é feita em tempo real através dos props
  };
      ...
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground">
            Explore oportunidades em diversas áreas e localizações
          </p>
        </div>
          ...
          <div className="bg-card rounded-2xl p-4 shadow-lg border border-border animate-slide-in">
            <div className="flex flex-col md:flex-row gap-3">
              <div className="flex-1 relative">
                ...
                <Input
                  placeholder="Oportunidade ou palavra-chave"
